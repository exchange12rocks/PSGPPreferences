    ...
    InModuleScope PSGPPreferences {
        ...
        Describe 'UNIT: Get-GPPSection' {
            ...
            Context 'Groups-GroupsOnly-Set-1' {
                BeforeAll {
                    $GPPSection = Get-GPPSection -GPOId 'f0a0c308-2fb0-433b-8a00-cc48b9ad1eba' -Context 'Machine' -Type 'Groups'
                }
            ...
            Context 'Groups-GroupsOnly-Set-2' {
                BeforeAll {
                    $GPPSection = Get-GPPSection -GPOId '4c6924d8-020a-4362-8a42-5977fcb3a06e' -Context 'Machine' -Type 'Groups'
                }
                ...
                Context 'Groups' {
                    ...
                    Context 'Attributes' {
                        ...
                        It 'Element is enabled' {
                            $XMLDocumentRoot.Groups.disabled | Should -Be '0'
                        }
                    }
                ...
                Context 'Groups' {
                    ...
                    Context 'Attributes' {
                        ...
                        It 'Element is disabled' {
                            $XMLDocumentRoot.Groups.disabled | Should -Be '1'
                        }
                    }
        ...
        Describe 'ACCEPTANCE: Serialize-GPPSection' {
            Context 'Groups-GroupsOnly-Set-1' {
                ...
                Context 'Without Type' {
                    BeforeAll {
                        $XMLDocumentRoot = Serialize-GPPSection -InputObject $GPPSection
                    }
                ...
                Context 'With Type' {
                    BeforeAll {
                        $Result = Serialize-GPPSection -InputObject $GPPSection -IncludeType
                    }
                        ...
                        Context 'Attributes' {
                            Context 'Type' {
                                It 'Type has correct type' {
                                    $Result.Type | Should -BeOfType [GPPType]
                                }
                                It 'Type has correct value' {
                                    $Result.Type | Should -Be ([GPPType]::Groups)
                                }
                            }

                            Context 'XMLDocument' {
                                BeforeAll {
                                    $XMLDocumentRoot = $Result.XMLDocument
                                }
